...
export const ModalTrigger = ({
  ...
  return (
    <button
      className={cn(
        "px-4 py-2 rounded-md text-black dark:text-foreground text-center relative overflow-hidden",
        className
      )}
  ...
  return (
    ...
    >
      <svg
        ...
        className="text-black dark:text-foreground h-4 w-4 group-hover:scale-125 group-hover:rotate-3 transition duration-200"
      >
