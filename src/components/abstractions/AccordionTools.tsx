...
const toolList = [
  ...
  {
    tool: "DuckDuckGo",
    description: "consulta a internet para responder a pergunta do usuário",
  },
  {
    tool: "SQL",
    description:
  ...
  },
  {
    tool: "Python REPL",
    description:
      "Um shell Python. Use isso para executar comandos Python. A entrada deve ser um comando Python válido. Se você quiser ver a saída de um valor, deve imprimi-lo com print(...). Sempre salve os gráficos em static/python_repl/arquivo.png (caminho relativo).",
  },
];
            ...
            <AccordionTrigger className="py-2 leading-6 hover:no-underline">
              <span className="flex items-center gap-3">
                <SquareFunctionIcon
                  ...
                  aria-hidden="true"
                />
                <h2 className="m-0 text-lg bg-transparent"> {item.tool}</h2>
              </span>
            </AccordionTrigger>
